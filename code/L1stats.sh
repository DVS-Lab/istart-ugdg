...
# Note that the directory for the EVFiles changes for UGDG depending on whether we use parametric regressorss or not.
EVDIR=${maindir}/derivatives/fsl/EVfiles/sub-${sub}/ugdg_GLM3/run-0${run} # zero padded
