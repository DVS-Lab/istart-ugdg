...
# Inputs
L3_model_dir=L3_task-ugdg_model-1_COMPOSITE_wSTRAT_n54_flame1.fsf #L3_task-ugdg_COMPOSITE_n54_flame1.fsf
TYPE=ppi_seed-Insula_extracted #act #w #nppi-ecn ppi_seed-NAcc-bin
N=54
cov=COMPOSITE_wSTRAT #_noINT
...
for ROI in 'pTPJ_extracted' 'seed-NAcc-thr' 'seed-vmPFC-5mm-thr' 'seed-ACC-50-thr' 'seed-SPL-thr'  'seed-mPFC-thr' 'seed-dlPFC-thr' 'seed-pTPJ-bin' 'seed-insula-thr'  'seed-insula-thr' 'seed-PCC_abb_extracted' 'seed-PCC_int_extracted' 'IFG_extracted' 'Insula_extracted' 'Angular_extracted'; do 
